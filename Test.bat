...
set DEVTOOL_OPTIONS=-p=SPI_driver.FullSysIdeProj -AutoBuild -Autorun -IAcceptLicense -NoEnvFile -Minimize -lf5=Sim.Log -q
...
echo .
echo All SPI System Tests Pass
